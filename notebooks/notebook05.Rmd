...
Unlike in `glm` we specify the family name in quotes. We will use a
"multinomial" model here so that our code can be used verbatim in situations
with more than two categories (we will see this in the lab today).
